...
import 'package:shiki_admin/core/api/discord_bot_api/discord_bot_api_client.dart'
    as _i4;
import 'package:shiki_admin/core/di/modules/network_module.dart' as _i8;
import 'package:shiki_admin/core/di/modules/preference_module.dart' as _i9;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i4.DiscordBotApiClient>(
        () => _i4.DiscordBotApiClient(gh<_i3.Dio>()));
    await gh.factoryAsync<_i5.SharedPreferences>(
      () => preferenceModule.sharedPreferences,
      preResolve: true,
    );
    gh.lazySingleton<_i6.AuthStorage>(
        () => _i6.AuthStorage(gh<_i5.SharedPreferences>()));
    gh.lazySingleton<_i7.AuthBloc>(() => _i7.AuthBloc(gh<_i6.AuthStorage>()));
    return this;
  }
}
